...
class CountryController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        $behaviors['access']['rules'] = [
            [
                ...
                'actions' => ['index'],
                'verbs' => ['GET'],
                'roles' => ['admin.setting.country.list'],
            ],
            [
                'allow' => true,
                'actions' => ['add'],
                'verbs' => ['GET', 'POST'],
                'roles' => ['admin.setting.country.add'],
            ],
            [
                'allow' => true,
                'actions' => ['update'],
                'verbs' => ['GET', 'POST', 'PATCH'],
                'roles' => ['admin.setting.country.update'],
            ],
            [
                'allow' => true,
                'actions' => ['delete'],
                'verbs' => ['POST', 'DELETE'],
                'roles' => ['admin.setting.country.delete'],
            ],
            [
                'allow' => true,
                'actions' => ['enable'],
                'verbs' => ['POST'],
                'roles' => ['admin.setting.country.visibility'],
            ],
            [
                'allow' => true,
    ...
    {
        $model = $this->getModel($code, Country::class);
    ...
    /**
     * @param string         $code
     * @param string|Country $modelClass
     * @param null|Closure   $queryFilter
     *
     * @return string|Response|Country
     * @throws InvalidConfigException
     */
    public function getModel($code, $modelClass = Country::class, $queryFilter = null)
    {
