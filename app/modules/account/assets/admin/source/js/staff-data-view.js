(function($){
  ...
  var StaffDataView = function($dataView){
    var self = this;
  ...
  $.fn.staffDataView = function(first, second, third){
    var staffDataView = this.data("staffDataView");

    if (!staffDataView) {
      if (typeof first === "undefined" || typeof first === "object") {
        staffDataView = new StaffDataView(this, first);

        this.data("staffDataView", staffDataView);
      }

      return this;
    }

    return staffDataView[first](second, third);
  };
