<?php namespace modules\account\models\forms\staff_account;
 ...
 *
 * @property StaffAccount|null $current
 */
class StaffAccountLogin extends StaffAccount
{
    public $remember_me;
    protected $_current;
    ...
    /**
     * @return null|StaffAccount
     * @throws InvalidConfigException
     */
    public function getCurrent()
    {
        if (!$this->_current) {
            $this->_current = StaffAccount::find()->username($this->username)->one();
        }
