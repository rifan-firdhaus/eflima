...
class LeadSourceController extends Controller
{
    ...
    {
        $model = $this->getModel($id, LeadSource::class);

        if (!($model instanceof LeadSource)) {
            return $model;
        }
    ...
    /**
     * @param integer           $id
     * @param string|LeadSource $modelClass
     * @param null|Closure      $queryFilter
     *
     * @return string|Response|LeadSource
     * @throws InvalidConfigException
     */
    public function getModel($id, $modelClass = LeadSource::class, $queryFilter = null)
    {
