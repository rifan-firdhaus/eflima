    ...
    'columns' => [
        ...
        [
            ...
            'content' => function ($model) {
                ...
                return Html::a($colorLabel . $label, ['/task/admin/task-status/update', 'id' => $model->id], [
                    'data-lazy-modal' => 'task-status-form',
        ...
        [
            ...
            'url' => function ($value, $model) {
                ...
                return ['/task/admin/task-status/enable', 'id' => $model->id, 'enable' => $value];
            },
        ],
        [
        ...
        [
            ...
            'controller' => '/task/admin/task-status',
            'sort' => 1000000,
            'buttons' => [
                'view' => false,
                'update' => [
                    'visible' => Yii::$app->user->can('admin.setting.task.task-status.update'),
                    'value' => [
                        'icon' => 'i8:edit',
                        'label' => Yii::t('app', 'Update'),
                        'data-lazy-container' => '#main-container',
                        'data-lazy-modal-size' => 'modal-md',
                        'data-lazy-modal' => 'task-status-form-modal',
                    ],
                ],
                'delete' => [
                    'visible' => Yii::$app->user->can('admin.setting.task.task-status.delete'),
                    'value' => [
                        'icon' => 'i8:trash',
