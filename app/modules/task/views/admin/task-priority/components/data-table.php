    ...
    'columns' => [
        ...
        [
            ...
            'content' => function ($model) {
                ...
                return Html::a($colorLabel . $label, ['/task/admin/task-priority/update', 'id' => $model->id], [
        ...
        [
            ...
            'url' => function ($value, $model) {
                ...
                return ['/task/admin/task-priority/enable', 'id' => $model->id, 'enable' => $value];
            },
        ],
        [
        ...
        [
            ...
            'buttons' => [
                'view' => false,
                'update' => [
                    'visible' => Yii::$app->user->can('admin.setting.task.task-priority.update'),
                    'value' => [
                        'icon' => 'i8:edit',
                        'label' => Yii::t('app', 'Update'),
                        'data-lazy-container' => '#main-container',
                        'data-lazy-modal-size' => 'modal-md',
                        'data-lazy-modal' => 'task-priority-form-modal',
                    ],
                ],
                'delete' => [
                    'visible' => Yii::$app->user->can('admin.setting.task.task-priority.delete'),
                    'value' => [
                        'icon' => 'i8:trash',
