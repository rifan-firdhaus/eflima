(function($){
  ...
  var ExpenseDataView = function($dataView){
    var self = this;
  ...
  $.fn.expenseDataView = function(first, second, third){
    var expenseDataView = this.data("expenseDataView");

    if (!expenseDataView) {
      if (typeof first === "undefined" || typeof first === "object") {
        expenseDataView = new ExpenseDataView(this, first);

        this.data("expenseDataView", expenseDataView);
      }

      return this;
    }

    return expenseDataView[first](second, third);
  };
