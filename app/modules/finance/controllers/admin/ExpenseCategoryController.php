...
class ExpenseCategoryController extends Controller
{
    ...
    {
        $model = $this->getModel($id, ExpenseCategory::class);
    ...
    /**
     * @param integer                $id
     * @param string|ExpenseCategory $modelClass
     * @param null|Closure           $queryFilter
     *
     * @return string|Response|ExpenseCategory
     * @throws InvalidConfigException
     */
    public function getModel($id, $modelClass = ExpenseCategory::class, $queryFilter = null)
    {
