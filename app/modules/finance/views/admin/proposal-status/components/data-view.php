...
$dataView = DataView::begin(ArrayHelper::merge([
    ...
    'searchAction' => $searchModel->searchUrl('/finance/admin/proposal-status/index'),
], $dataViewOptions));
...
if (Yii::$app->user->can('admin.setting.finance.proposal-status.add')) {
    echo Html::a(Icon::show('i8:plus') . Yii::t('app', 'Create'), ['/finance/admin/proposal-status/add'], [
