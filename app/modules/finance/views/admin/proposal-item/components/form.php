...
use modules\finance\assets\admin\ProposalItemFormAsset;
...
ProposalItemFormAsset::register($this);
...
if (Yii::$app->request->get('temp')) {
    ...
    echo Html::hiddenInput('proposal', Yii::$app->request->post('proposal'));
}
    ...
    [
        ...
        'fields' => [
            [
                ...
                'inputOptions' => [
                    'class' => 'form-control',
                    'id' => 'proposalitem-product_chooser',
                    'prompt' => '',
                ],
                'widget' => [
...
$this->registerJs("$('#{$form->id}').proposalItemForm()");
