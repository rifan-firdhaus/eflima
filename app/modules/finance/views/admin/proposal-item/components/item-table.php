...
<?php Card::begin([
    ...
    'title' => Yii::t('app', 'Proposal Items'),
]); ?>

<table class="table table-hover table-striped mb-0 proposal-item-table">
    <thead>
        <tr>
            <th width="10px"></th>
    ...
    <tfoot>
        <?php if (Yii::$app->user->can('admin.proposal.item.add')): ?>
            <tr>
                <td colspan="6">
                    <?= Html::a(Icon::show('i8:plus') . Yii::t('app', 'Add Item'), ['/finance/admin/proposal-item/add', 'proposal_id' => $model->id], [
                        'class' => 'btn text-uppercase btn-block btn-outline-primary add-proposal-item-button',
                        'data-lazy' => 0,
                    ]) ?>
                </td>
            </tr>
