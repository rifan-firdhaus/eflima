<?php namespace modules\finance\models\forms\tax;
 ...
 */
class TaxSearch extends Tax implements SearchableModel
{
    ...
    /**
     * @param TaxSearch|ActiveQuery|null $query
     *
     * @return TaxSearch|ActiveQuery
     *
    ...
    public function filterQuery($query = null)
    {
        ...
        $query->andFilterWhere(['tax.is_enabled' => $this->is_enabled])
            ->andFilterWhere(['like', 'tax.name', $this->q]);
