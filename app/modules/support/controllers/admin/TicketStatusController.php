...
class TicketStatusController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        $behaviors['access']['rules'] = [
            [
                ...
                'actions' => ['index'],
                'verbs' => ['GET'],
                'roles' => ['admin.setting.ticket.ticket-status.list'],
            ],
            [
                'allow' => true,
                'actions' => ['add'],
                'verbs' => ['GET', 'POST'],
                'roles' => ['admin.setting.ticket.ticket-status.add'],
            ],
            [
                'allow' => true,
                'actions' => ['update'],
                'verbs' => ['GET', 'POST', 'PATCH'],
                'roles' => ['admin.setting.ticket.ticket-status.update'],
            ],
            [
                'allow' => true,
                'actions' => ['delete'],
                'verbs' => ['POST', 'DELETE'],
                'roles' => ['admin.setting.ticket.ticket-status.delete'],
            ],
            [
                'allow' => true,
                'actions' => ['enable'],
                'verbs' => ['POST'],
                'roles' => ['admin.setting.ticket.ticket-status.visibility'],
            ],
        ];
    ...
    {
        $model = $this->getModel($id, TicketStatus::class);
    ...
    /**
     * @param integer             $id
     * @param string|TicketStatus $modelClass
     * @param null|Closure        $queryFilter
     *
     * @return string|Response|TicketStatus
     * @throws InvalidConfigException
     */
    public function getModel($id, $modelClass = TicketStatus::class, $queryFilter = null)
    {
