...
$dataTable = DataTable::begin(ArrayHelper::merge([
    ...
    'id' => 'ticket-predefined-reply-data-table',
    'card' => false,
    'linkPager' => false,
    'idAttribute' => 'id',
    'lazy' => false,
    'columns' => [
        ...
        [
            ...
            'content' => function ($model) {
                ...
                $name = Html::tag('span', Html::encode($model->title));

                return Html::a($name, ['/support/admin/ticket-predefined-reply/update', 'id' => $model->id], [
        ...
        [
            ...
            'url' => function ($value, $model) {
                /** TicketPredefinedReply $model */

                return ['/support/admin/ticket-predefined-reply/enable', 'id' => $model->id, 'enable' => $value];
            },
        ],
        [
        ...
        [
            ...
            'controller' => '/support/admin/ticket-predefined-reply',
            'sort' => 1000000,
            'buttons' => [
                'view' => false,
                'update' => [
                    'value' => [
                        ...
                        'data-lazy-container' => '#main-container',
                        'data-lazy-modal-size' => 'modal-md',
                        'data-lazy-modal' => 'ticket-predefined-reply-form-modal',
                    ],
                ],
            ],
        ],
