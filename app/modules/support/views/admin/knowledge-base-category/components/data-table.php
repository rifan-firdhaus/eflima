...
$dataTable = DataTable::begin(ArrayHelper::merge([
    ...
    'id' => 'knowledge-base-category-data-table',
    'card' => false,
    'linkPager' => false,
    'idAttribute' => 'id',
    'lazy' => false,
    'columns' => [
        ...
        [
            ...
            'content' => function ($model) {
                ...
                return Html::a(Html::encode($model->name), ['/support/admin/knowledge-base-category/update', 'id' => $model->id], [
        ...
        [
            ...
            'url' => function ($value, $model) {
                ...
                return ['/support/admin/knowledge-base-category/enable', 'id' => $model->id, 'enable' => $value];
            },
        ],
        [
        ...
        [
            ...
            'controller' => '/support/admin/knowledge-base-category',
            'sort' => 1000000,
            'buttons' => [
                'view' => false,
                'update' => [
                    'visible' => Yii::$app->user->can('admin.knowledge-base.category.update'),
                    'value' => [
                        'icon' => 'i8:edit',
                        'label' => Yii::t('app', 'Update'),
                        'data-lazy-container' => '#main-container',
                        'data-lazy-modal-size' => 'modal-md',
                        'data-lazy-modal' => 'knowledge-base-category-form-modal',
                    ],
                ],
                'delete' => [
