 ...
 *
 * This is the ActiveQuery class for [[\modules\support\models\KnowledgeBaseCategory]].
 *
 * @see    KnowledgeBaseCategory
 */
class KnowledgeBaseCategoryQuery extends ActiveQuery
{
    use VisibilityQuery;
     ...
     * @inheritdoc
     *
     * @return KnowledgeBaseCategory[]|array
     */
     ...
     * @inheritdoc
     *
     * @return KnowledgeBaseCategory|array|null
     */
