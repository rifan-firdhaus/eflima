<?php namespace modules\support\models\forms\ticket_status;
 ...
 */
class TicketStatusSearch extends TicketStatus implements SearchableModel
{
     ...
     * @inheritDoc
     *
     * @param TicketStatusQuery|ActiveQuery|null $query
     *
     * @return TicketStatusQuery|ActiveQuery
     *
    ...
    public function filterQuery($query = null)
    {
        ...
        $query->andFilterWhere(['ticket_status.is_enabled' => $this->is_enabled])
            ->andFilterWhere(['like', 'ticket_status.label', $this->q]);
