<?php namespace modules\support\models\forms\ticket_department;
 ...
 */
class TicketDepartmentSearch extends TicketDepartment implements SearchableModel
{
    ...
    /**
     * @param TicketDepartmentQuery|ActiveQuery|null $query
     *
     * @return TicketDepartmentQuery|ActiveQuery
     *
    ...
    public function filterQuery($query = null)
    {
        ...
        $query->andFilterWhere(['ticket_department.is_enabled' => $this->is_enabled])
            ->andFilterWhere(['like', 'ticket_department.name', $this->q]);
     ...
     * @inheritdoc
     *
     * @return ActiveQuery|TicketDepartmentQuery
     *
     * @throws InvalidConfigException
     */
