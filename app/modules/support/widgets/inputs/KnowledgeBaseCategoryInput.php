 ...
 */
class KnowledgeBaseCategoryInput extends Select2Input
{
    public $_query;
    ...
    /**
     * @param KnowledgeBaseCategoryQuery $query
     */
    ...
    /**
     * @return KnowledgeBaseCategoryQuery
    ...
    {
        if ($this->allowAdd) {
            $createTagJs = "function(params){return params.term ? {id: params.term,text: params.term,isNew: true}: {}}";
