...
*/
	...
	var getQueryParts = function(query){
		...
		//		ordered array of query components structures (or "parts"). Each
		...
		for(; lc=cc, cc=query.charAt(x), x < ql; x++){
			...
			if(!currentPart){ // a part was just ended or none has yet been created
				...
				currentPart = {
					...
					oper: null, // ...or operator per components. Note that these wind up being exclusive.
					id: null,	// the id components of a rule
					getTag: function(){
...
define(["./kernel", "./lang", "./array", "./config"], function(dojo, lang, ArrayUtil, config){
	...
	lang.extend(Color, {
		...
		toRgb: function(){
			// summary:
			//		Returns 3 components array of rgb values
			// example:
