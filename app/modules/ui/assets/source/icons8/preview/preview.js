$(document).ready(function(){
  ...
  $cheatcodeInputs.on("mouseup", onCheatcodeFocus).on("click", onCheatcodeFocus).on("focus", onCheatcodeFocus);
  ...
  function onSearch(e){
    ...
    $icons.hide().filter(function(){ return nameRegex.test(this.getAttribute("data-name")); }).filter(function(){ return nameRegex.test(this.getAttribute("data-name")); }).show()
    ;
  }
  ...
  function onFontFamilyChanged(e){
    var val = e.target.value.trim();
    $textarea.css("font-family", "Eflima, " + val);
  }
